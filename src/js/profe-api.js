  ...
  return el('div', {},
    el('div', { cls: 'tarjeta' },
      ...
      el('ol', { cls: 'pasos', estilo: { marginTop: '14px' } },
        el('li', {}, el('div', { html: tx('Entrá a <a href="https://console.anthropic.com/settings/keys" target="_blank" rel="noopener noreferrer">console.anthropic.com</a> y creá una clave.') })),
